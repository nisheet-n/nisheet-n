...
export default function Skills() {
  return (
    <section id="skills" className="relative py-12 sm:py-14 md:py-20" data-testid="section-skills">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          {skillCategories.map((category, index) => (
            <div
              key={category.title}
              className={`group relative overflow-hidden rounded-xl border ${category.borderColor} bg-card p-4 sm:p-5 md:p-6 transition-all duration-300 hover:shadow-lg hover:shadow-black/5 dark:border-border dark:hover:shadow-black/20`}
