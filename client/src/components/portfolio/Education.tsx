import { GraduationCap, Award, Trophy, Users, Heart, Star, ExternalLink } from "lucide-react";
...
const awards: AwardItem[] = [
  ...
  { title: "Received 2 Shoutouts for performance (top 1 of 11 interns) during Deloitte internship and as full-time employee", icon: Star, highlight: true },
...
const leadership: LeadershipItem[] = [
  ...
  { title: "Led as Vice Captain for team of 10+ participants for Intercity carrom tournament", icon: Trophy },
...
export function Education() {
  return (
    <section id="education" className="py-16 md:py-24 bg-muted/30 relative" data-testid="section-education">
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-16">
          {education.map((edu, index) => (
            <Card key={index} className="overflow-visible hover-elevate" data-testid={`education-item-${index}`}>
              ...
              {awards.map((award, index) => (
                <div
                  ...
                  className={`flex items-start gap-3 p-3 rounded-md ${
                    award.highlight ? "bg-primary/10 border border-primary/20" : "bg-card border border-card-border"
                  }`}
